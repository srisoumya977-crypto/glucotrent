...
# GLUCOTREND PREDICTION USING RAW DATASET
# ================================================================
#
# IMPORTANT:
...
DATASET_PATH = (
   r"C:/Users/HP/PycharmProjects/mlM3/GlucoTrend/dataset"
   r"\target_engineered_M2.csv"
)
...
OUTPUT_FOLDER = (
   r"C:/Users/HP/PycharmProjects/mlM3/GlucoTrend/outputs"
   r"\Decision_Tree_Classifier_M3_Outputs"
)
...
print(
   "             DECISION TREE GLUCOTREND PREDICTION"
)
...
columns_to_drop = [
    target_column,
    "user_id", "timestamp", "device_id", "timezone", "region", "notes",
    "glucose", "glucose_lead_1", "glucose_lead_3", "glucose_lead_6",
    "target_binary", "target_ada3", "target_5class", 
    "glucose_roc_per_min", "target_trend"
]
columns_to_drop = [col for col in columns_to_drop if col in data_model.columns]
